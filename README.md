...
<p align="justify">:pencil2: <abbr title="Work In Progress"><b>Python</b></abbr><b>.</b> For information concerning the Python Standalone, along with its BIDS-App through Dockers, head over to https://github.com/BIDS-Apps/rsHRF!</p>
<br>

<abbr title="latest version of the rsHRF toolbox (v2.2)">MATLAB</abbr>
